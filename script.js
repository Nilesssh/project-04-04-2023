...
function retrieveData(){
    ...
    var arr=[count,name,email,gpa,age,degree];
    if(arr.includes("")){
        return false;
    }
    else{
...
var c = localStorage.setItem("ID's",dataEntered[0])
var n=localStorage.setItem("Name",dataEntered[1]);
var j=localStorage.setItem("Email",dataEntered[2]);
var e=localStorage.setItem("Gpa",dataEntered[3]);
var q=localStorage.setItem("Age",dataEntered[4]);
var w=localStorage.setItem("Degree",dataEntered[5]);

var c1=localStorage.getItem("ID's",c);
...
function insert(readData){
    ...
    row.insertCell(6).innerHTML=`<button onclick=edit(this)>Edit</button>
